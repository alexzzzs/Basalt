...
- Column-to-column arithmetic operations: `AddColumns`, `SubtractColumns`, `MultiplyColumns`, `DivideColumns`, `PowerColumns`
- Support for mixed numeric types (Float64 and Int64) in arithmetic operations with automatic type promotion
- Comprehensive test coverage for new column-to-column operations
- Updated documentation with examples of column-to-column operations
